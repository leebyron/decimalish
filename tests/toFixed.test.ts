...
describe('toFixed', () => {
  it('prints Numeric in fixed notation', () => {
    ...
    expect(toFixed('12345678901234567890.1234567890123456789')).toBe('12345678901234567890.1234567890123456789')
  })
  ...
  it('supports rounding mode', () => {
    ...
    expect(toFixed('0.00123456', { precision: 8, mode: 'up' })).toBe('0.0012345600')
