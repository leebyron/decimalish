...
describe('toExponential', () => {
  it('prints Numeric in exponential notation', () => {
    ...
    expect(toExponential('12345678901234567890.1234567890123456789')).toBe('1.23456789012345678901234567890123456789e+19')
  })
  ...
  it('supports rounding mode', () => {
    ...
    expect(toExponential('0.00123456', { precision: 1, mode: 'up' })).toBe('2e-3')

    expect(toExponential('123456', { precision: 4, mode: 'up' })).toBe('1.235e+5')
    expect(toExponential('123.456', { precision: 4, mode: 'up' })).toBe('1.235e+2')
    expect(toExponential('1.23456', { precision: 4, mode: 'up' })).toBe('1.235e+0')
    expect(toExponential('0.123456', { precision: 4, mode: 'up' })).toBe('1.235e-1')
    expect(toExponential('0.00123456', { precision: 4, mode: 'up' })).toBe('1.235e-3')

    expect(toExponential('123456', { precision: 8, mode: 'up' })).toBe('1.2345600e+5')
    expect(toExponential('123.456', { precision: 8, mode: 'up' })).toBe('1.2345600e+2')
    expect(toExponential('1.23456', { precision: 8, mode: 'up' })).toBe('1.2345600e+0')
    expect(toExponential('0.123456', { precision: 8, mode: 'up' })).toBe('1.2345600e-1')
    expect(toExponential('0.00123456', { precision: 8, mode: 'up' })).toBe('1.2345600e-3')
    ...
    expect(toExponential('0.123456', { precision: -1, mode: 'up' })).toBe('1e+1')
    expect(toExponential('0.00123456', { precision: -1, mode: 'up' })).toBe('1e-1')
  })
})
